---
name: cwork-test
description: 页面自动化测试，ego-browser 驱动 + 三种工作流 + 截图验证（page-agent 备选）
---
...
`cwork-test` 是 cwork 的测试技能，通过 ego-browser 驱动真实浏览器执行自动化测试。支持语义/视觉/CDP 三种工作流，可截图验证、精确断言、任务空间隔离，无需编写测试代码。
